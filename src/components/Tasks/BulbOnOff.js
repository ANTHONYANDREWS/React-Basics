...
class BulbOnOff extends Component {
    ...
    render() {
        ...
        return(
            <>
                <img src= {bulbStatus ? bulbOnImg: bulbOffImg} height="500" alt="bulb" />
                <br />
                <br />
                <br />
                ...
                <button style={{
                    ...
                    fontSize: "2em",
                    marginRight: "10px"
                 }} onClick={this.turnBulbOn}>On</button>
                ...
                onClick={this.turnBulbOff}>Off</button>
                ...
                onClick={this.switchBulb}>{this.state.bulbStatus ? 'Turn Off' : 'Turn On'}</button>
